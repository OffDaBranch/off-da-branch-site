# Cannabis IP Brand Licensing Rules
...
## Purpose
Cannabis IP ownership, brand usage, licensing, royalty, white-label, media clearance, licensee onboarding, and brand risk controls.

## Required Controls
- IP ownership source
- brand usage
- licensee/partner record
- royalty model review
