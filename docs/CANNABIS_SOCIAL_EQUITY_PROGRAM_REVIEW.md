# Cannabis Social Equity Program Review
...
## Purpose
Social equity, impact zone, community benefits, diversity documentation, local hiring, economic development, and community impact review controls.

## Required Controls
- eligibility basis
- community impact source
- documentation checklist
- public-claims review
- submission/founder gate

## Required Review
- Cannabis Compliance Lead.
- Cannabis Legal / Regulatory Affairs when assumptions affect license, claim, submission, filing, or launch.
- Source-of-Truth Owner.
- Founder Decision Gate when work affects launch, submission, public claim, banking/tax, facility, partner/licensee, investor statement, or legal/regulatory filing.
...
## Handoff
Use `docs/HANDOFF_TEMPLATE.md` plus the cannabis/hemp addendum.
