# Cannabis Security And Access Control
...
## Purpose
Facility security, surveillance, access control, logs, incident response, and privacy controls.

## Required Controls
- security plan outline
- surveillance/access review
- staff access roles
